...
def scrape ():
    ...
    news_list = news_soup.find_all('ul', class_='item_list')
    for news in news_list:
        ...
        # #-----------------------------------
        news_title.append(headline.strip())
        news_p.append(articles.strip())
        news_dict = {
            "news_headline": headline.strip(),
            "news_teaser": articles.strip()
            }
    #======================================================================
    ...
    image_url = jpl_soup.find_all("img", class_="thumb")["src"]
    featured_image_url.append("https://www.jpl.nasa.gov" + image_url)
    #======================================================================
    # 3- Mars Facts:
    #================
